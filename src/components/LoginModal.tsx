...
export function LoginModal({ isOpen, onClose, onLogin }: LoginModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-black border-white/10 text-white max-w-md font-montserrat">
        <DialogHeader>
          ...
          <DialogTitle className="font-bebas text-3xl text-center uppercase tracking-wider">
            Entre no <span className="text-[#d4af37]">Nexus Club</span>
          </DialogTitle>
          <DialogDescription className="text-gray-400 text-center">
            Faça login para acessar seu dashboard e resgatar prêmios
          </DialogDescription>
        </DialogHeader>
